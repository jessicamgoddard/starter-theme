...
function starter_theme_scripts_styles() {
  ...
  wp_enqueue_style( 'starter-theme-fonts', $starter_theme_config[ 'fonts-url' ] );
  wp_enqueue_style( 'dashicons' );
  wp_enqueue_style( 'starter-theme-main-css', get_stylesheet_directory_uri() . '/assets/dist/main.min.css' );
  wp_enqueue_style( 'starter-theme-inline-css', get_stylesheet_directory_uri() . '/assets/dist/inline.min.css' );
...
function starter_theme_gutenberg_scripts_styles() {
  ...
  wp_enqueue_style( 'starter-theme-editor-fonts', $starter_theme_config[ 'fonts-url' ] );
  wp_enqueue_style( 'dashicons' );
  wp_enqueue_style( 'starter-theme-editor-main-css', get_stylesheet_directory_uri() . '/assets/dist/editor.min.css' );
  wp_enqueue_style( 'starter-theme-editor-inline-css', get_stylesheet_directory_uri() . '/assets/dist/inline.min.css' );
